"""
Evaluation of GPT-3.5-turbo and GPT-4 on Counterintuitive Arithmetic Reasoning problems
"""
...
def solve_problem(problem, model_name, temperature, openai_api_key, sleep_time=0):
    """Solve a single problem using direct query to the specified model"""
...
At the end, clearly state your final answer in the format: "Final answer: [your answer]"
"""
    ...
    # Try to find a line with "Final answer:"
    for line in solution.split('\n'):
        if "final answer:" in line.lower():
            final_answer = line.lower().split("final answer:")[1].strip()
            break
    
    # If not found, look for lines with "answer" or "therefore"
    ...
    # If still not found, just use the last line
    if final_answer is None:
...
def check_answer(solution, correct_answers):
    ...
    for answer in correct_answers:
        ...
        try:
            ...
            # For percentages
            if numeric_value <= 1:  # Likely a probability
...
def parse_args():
    ...
    parser.add_argument("-m", "--models", type=str, default="gpt-3.5-turbo,gpt-4", help="Comma-separated list of models to test")
    ...
    for model_name in models_to_test:
        ...
        for i, problem in enumerate(tqdm(problems)):
            ...
            result = solve_problem(
                ...
                sleep_time=1 if model_name.startswith("gpt-4") else 0  # Add delay for GPT-4 to avoid rate limits
            )
        ...
        accuracy_file = os.path.join(model_output_dir, "accuracy.txt")
